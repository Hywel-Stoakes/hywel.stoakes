...
summary = "The Acoustic Phonetics of Australian Languages"

# Optional image to display on homepage (relative to `static/img/` folder).
image_preview = "Galiwinku.jpg"

# Tags: can be used for filtering projects.
# Example: `tags = ["machine-learning", "deep-learning"]`
tags = ["Australian-Languages"]
...
This series is a general introduction to the sounds of Australian languages and does not represent the full degree of diversity in pronunciation amongst the languages of the Australian continent. It gives some examples from speakers of Australian languages and examples made by me, Hywel Stoakes, a non-Indigenous phonetician (Anglo-Celtic background).
